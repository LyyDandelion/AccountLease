                    ...
                    <div class="tab-pane active" id="horizontal-form">
                        <form class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input disabled="" type="text" class="form-control1" id="username">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control1" id="question">
                                </div>
                                <div class="col-sm-2 jlkdfj1">
                                    <p class="help-block"></p>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control1" id="answer">
                                </div>
                                <div class="col-sm-2 jlkdfj1">
                                    <p class="help-block"></p>
                                </div>
                        ...
                        <div class="panel-footer">
                            <div class="row">
                                <div class="col-sm-8 col-sm-offset-2" style="margin-left: 30%;">
                                    <button id="submit" class="btn btn-success  btn-lg" style="width: 25%;">提交</button>
                                    <button id="cancel" class="btn btn-default btn-lg" style="width: 25%;">取消</button>
                                </div>
                            </div>
                        </div>
                    </div>
